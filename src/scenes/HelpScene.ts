...
export class HelpScene extends Phaser.Scene {
    ...
    return [
      ...
      },
      {
        ...
        lines: [
          ...
          "場上一開始就是 3×3，橫陣、縱陣、斜陣從第一關就都排得出來。",
      ...
      },
      {
        ...
        lines: [
          "符籙譜上方有三顆鍵：排序、篩選、比較。",
          "排序可切成每秒輸出／出手快慢／道數，格子上會直接寫那個數字——",
          "看得到差多少，才判斷得出「值不值得為它換一張」。",
          "篩選只把不符合的變暗，不會把它們藏起來。",
          "比較模式下點符不會動到你的配置，最多三張並排看規格與特效。",
          "每秒輸出已經把你門派的專精算進去了。",
        ],
      },
      {
      ...
      },
      {
        ...
        lines: [
          ...
          "洞府五條線與副本進度全部重來，但門派修為、成就與紀錄都留著。",
          "（符籙的解鎖來源是藏經閣，所以它也跟著重來——下一世要重新打回那十六張。）",
          "仙緣點買的是每一世都帶著走的加成——法寶傷害、金幣、山門耐久，",
          "以及最有感的「法寶階數上限 +1」，四條線都沒有等級上限。",
          "只要進了飛升境就一定換得到點，推得比上一世更深則額外再多換一些。",
          "**每轉一世，世界也跟著變硬**：飛升境的妖魔會照上一世的深度往上推，",
          "而且愈來愈多妖魔帶著習性出場。仙緣讓你更強，周目讓牠們更難——",
          "第二世的第 82 關不是第一世的第 82 關。",
        ],
      },
      {
        title: "四座副本",
        lines: [
          "主畫面的「副本」裡有四座，每一座只給一種東西，而且只有它給：",
          "・藏經閣：唯一的符籙來源。除了起手那幾張，其餘十幾張都要打過一層才參悟。",
          "　規則是「只能帶一張符」——沒得換符，只能靠合成硬推。",
          "・斷崖：門派修為。規則是「不能合成」，整場只有抽到的階數可用。",
          "・鎮妖塔：仙緣點。規則是「山門耐久只有三成」，漏一隻就傷筋動骨。",
          "・聚寶洞：金幣，倍率最高，而且可以重複打。",
          "　它沒有終點：打完一關就直接接下一關，深度一路往上加，",
          "　打到守不住為止——走多深就拿多少。",
          "每一層都有自己的門檻，看的是「你**這一世**主線推到第幾關」。",
          "副本不推進主線、也不上榜：那是另一條路，不是同一條路的捷徑。",
          "",
          "**轉世會把副本整條清空**，門檻也跟著回到第 1 關，所以下一世要重走一次；",
          "而且同一層會比上一世更深——你上一世走得愈遠，重走的這一趟愈硬。",
          "深度永遠不會超過那一層的門檻：副本難的是規則，不是深度。",
        ],
      },
      {
        title: "存檔在哪裡",
        lines: [
          ...
          "那一頁還有「匿名統計」開關：送出的只有關卡進度之類的數字，",
          "用來調整難度曲線，不含任何個人資料，不想送可以關掉。",
        ],
      },
      {
        title: "洞府升級",
        lines: [
          "通關拿的金幣在洞府換成永久加成，五條線都會影響下一關。",
          "每條線都能點到 100 級，愈往後愈貴——金幣永遠有地方去。",
          "打不過就先回洞府買幾級，這是設計上預期的循環。",
          "",
          "推到飛升境（第 82 關）之後，最下面會多出一條「門派秘傳」：",
          "它沒有等級上限，而且每一派加的東西都不一樣——",
          "天罡宗加山門耐久、青霄劍宗加首領傷害、",
          "玄符門加自己專精的那張符、百草丹閣加金幣。",
          "等級跟著門派記，換派就是另一條，回去的時候還在；",
          "但它是用金幣買的，所以和洞府一樣，輪迴時歸零。",
        ],
      },
    ];
  }
  ...
  create(): void {
    ...
    this.add
      .text(cx, 46, "玩法說明", textStyle({ size: 40, color: INK, bold: true }))
      .setOrigin(0.5);
    this.add
      .text(
        cx,
        92,
        "完整規則，隨時查閱（教學會在用得到的那一關自己出現）",
